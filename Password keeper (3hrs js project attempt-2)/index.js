...
function handleFormSubmit(event) {
  ...
  axios
    .post(
      "https://crudcrud.com/api/32e1e259704f4a6491bdc39363672be6/password",
      userdetails
    )
    .then((response) => {
...
function displayUserOnScreen(userdetails) {
  ...
  deleteBtn.addEventListener("click", function () {
    axios
      .delete(
        `https://crudcrud.com/api/32e1e259704f4a6491bdc39363672be6/password/${userdetails._id}` //delete from cloud using specific id
      )
      .then(() => {
  ...
  editBtn.addEventListener("click", function () {
    ...
    axios
      .put(
        `https://crudcrud.com/api/32e1e259704f4a6491bdc39363672be6/password${userdetails._id}`,
        updatedUserDetails
      )
      .then(() => {
...
window.addEventListener("DOMContentLoaded", () => {
  axios
    .get("https://crudcrud.com/api/32e1e259704f4a6491bdc39363672be6/password")
